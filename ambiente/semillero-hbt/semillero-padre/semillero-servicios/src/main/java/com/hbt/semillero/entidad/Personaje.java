...
public class Personaje implements Serializable {
	 ...
	 */
	@Id
	@SequenceGenerator(allocationSize = 1, name = "PERSONAJE_SCID_GENERATOR", sequenceName = "SEQ_PERSONAJE")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "PERSONAJE_SCID_GENERATOR")
	@Column(name = "SCID")
	public Long getId() {
		return id;
	}
